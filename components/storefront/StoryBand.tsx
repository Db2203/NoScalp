  ...
  return (
    <section className="border-b border-edge">
      <Container className="grid items-stretch gap-0 py-16 sm:py-20 lg:grid-cols-2">
        ...
        <div className="flex flex-col justify-center rounded-3xl bg-fg p-10 text-canvas lg:rounded-l-none">
          <Kicker className="text-canvas/60">The story</Kicker>
          ...
          <p className="mt-5 max-w-md leading-relaxed text-canvas/75">
